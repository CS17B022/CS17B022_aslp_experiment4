#this example has overflow
.data
b13:	.word -2147483648	#(10000000000000000000000000000000)
...
b23:	.word -2147483648	#(10000000000000000000000000000000)
...
#the sum of these two numbers should give an error as there is overflow
.text
main:
la $t3,b13
la $t2,b12
...
sw $s3,0($t3)		#result stored in memory
